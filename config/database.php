...
return [
    ...
    */
    ...
    'connections' => [
        ...
        // Base de PRUEBAS (misma estructura que producción). Sirve para probar
        // migraciones/queries sin tocar la BD real: usar --database=mysql_pruebas.
        // Ver CLAUDE.md: todo cambio de esquema se aplica también aquí.
        'mysql_pruebas' => [
            'driver' => 'mysql',
            'host' => env('DB_PRUEBAS_HOST', '127.0.0.1'),
            'port' => env('DB_PRUEBAS_PORT', '3306'),
            'database' => env('DB_PRUEBAS_DATABASE', 'laravel'),
            'username' => env('DB_PRUEBAS_USERNAME', 'root'),
