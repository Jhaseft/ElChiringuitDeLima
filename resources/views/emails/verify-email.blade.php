                ...
                <table width="600" cellpadding="0" cellspacing="0" style="background-color:#ffffff; border-radius:8px; overflow:hidden;">
                    ...
                    <tr>
                        <td style="padding:20px; text-align:center;">
                            ...
                            style="display:inline-block; padding:12px 25px; margin:20px 0; background-color:#FF6600; color:#ffffff; text-decoration:none; border-radius:5px; font-weight:bold;">
                                Verificar correo
                            </a>
