...
export default function Register() {
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center bg-gray-100 px-4 sm:px-6 py-10">
      ...
      <div className="w-full max-w-3xl bg-white rounded-3xl shadow-xl border-2 border-green-600 overflow-hidden p-8 sm:p-12">
        ...
        <div className="flex flex-col items-center mb-6">
          ...
          <p className="text-sm text-gray-500 mt-1">Únete a TransferCash hoy</p>
        </div>
        ...
        <form onSubmit={submit} className="space-y-6">
          ...
          <div className="flex justify-between mt-4">
            ...
            <button
              ...
              className="px-6 py-2.5 bg-green-700 text-white rounded-xl shadow-md hover:bg-green-800 transition disabled:opacity-50"
            >
