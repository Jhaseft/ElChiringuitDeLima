...
export default function CompleteProfile({ user }) {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-100 px-4 py-10">
      <div className="w-full max-w-lg bg-white rounded-2xl shadow-xl border-2 border-green-600 p-8 sm:p-12">
        <div className="flex flex-col items-center mb-6">
          ...
          <h1 className="text-2xl font-extrabold text-gray-800 text-center">Completa tu perfil</h1>
        ...
        <form onSubmit={submit} className="space-y-5">
          ...
          <div className="flex justify-between mt-6 gap-3">
            ...
            <button
              ...
              className="flex-1 px-6 py-2.5 bg-green-700 text-white rounded-xl shadow-md hover:bg-green-800 transition disabled:opacity-50 font-semibold"
            >
