                ...
                {DOCS.map((d) => {
                    ...
                    return (
                        <button
                            ...
                            className={`rounded-2xl border px-4 py-4 text-left shadow-sm hover:shadow transition ${active ? "border-indigo-600 ring-2 ring-indigo-200 bg-indigo-50" : "border-gray-200 bg-white"
                                }`}
                        >
                            <div className="flex items-center gap-3">
                                <span className={`p-2 rounded-full ${active ? "bg-indigo-600 text-white" : "bg-gray-100 text-gray-700"}`}>
                                    <Icon size={20} />
                                </span>
                                <div>
